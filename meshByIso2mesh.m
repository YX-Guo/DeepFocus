...
%YG modify, drill holes on cribriform plate
warning("YG moddified, drill holes on crib plate, assign conductivity")
[allMask,allMaskShow] = automatic_drill(allMask,allMaskShow);
